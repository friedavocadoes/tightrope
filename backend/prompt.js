...
async function run(mood, budget, loc, lang) {
    const prompt = `I want you to suggest me 6 vacation spots (around the world) based on my mood, budget and languages i speak.
    My mood: ${mood}, budget (in indian rupees): ${budget}, my current location: ${loc}, languages i speak: ${lang}.
